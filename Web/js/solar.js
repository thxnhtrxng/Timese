...
var sunInfoOverlay = document.getElementById('sun-info-overlay');
...
startBtn.onclick = function() {
  ...
  // Xử lý sự kiện click của nút stop
...
handleButtonClick('Venus');
handleButtonClick('Earth');
handleButtonClick('Mars');
handleButtonClick('Jupiter');
handleButtonClick('Saturn');
handleButtonClick('Uranus');
handleButtonClick('Neptune');
// Gán sự kiện cho các nút của các hành tinh khác ở đây
